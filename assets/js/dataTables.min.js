...
((n) => {
  ...
  r("cells()", function (g, e, m) {
    ...
    (V.defaults = {
      ...
      oLanguage: {
        ...
        sDecimal: "",
        sThousands: ",",
        sLengthMenu: "_MENU_ Table _ENTRIES_  ",
  ...
  if (void 0 !== W.Intl)
    try {
      for (
        var Mt = new Intl.NumberFormat().formatToParts(100000.1), l = 0;
        l < Mt.length;
        l++
      )
        "group" === Mt[l].type
          ? (Et = Mt[l].value)
          : "decimal" === Mt[l].type && (kt = Mt[l].value);
    } catch (e) {}
          ...
          !(function e(t, n, r) {
            ...
            var a = r.type ? V.ext.pager[r.type] : qt,
              ...
              i = a(r).map(function (e) {
                return "numbers" === e
                  ? zt(c, d, r.buttons, r.boundaryNumbers)
                  : e;
              });
